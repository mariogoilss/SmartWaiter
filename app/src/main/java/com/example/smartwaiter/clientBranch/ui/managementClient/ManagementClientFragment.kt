...
class ManagementClientFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_management_client, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ManagementClientFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ManagementClientFragment().apply {
